...
import com.webfaria.dscatalog.resources.ProductResource;
...
public class ProductResourceTests {
	...
	public void deleteShouldReturnNotFoundWhenDoesNotExist() throws Exception {
		ResultActions result = mockMvc
				.perform(delete("/products/{id}", nonExisistId).accept(MediaType.APPLICATION_JSON));
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		...
		ResultActions result = mockMvc.perform(put("/products/{id}", nonExisistId).content(jsonBody)
				.contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
...
//		mockMvc.perform(get("/products")).andExpect(status().isOk()); //Encadiado
	...
	public void findByIdShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
		ResultActions result = mockMvc.perform(get("/products/{id}", nonExisistId).accept(MediaType.APPLICATION_JSON));
